...
autocmd VimEnter,BufRead,BufNewFile *.c,*.h
    \ setlocal filetype=c | setlocal expandtab | setlocal shiftwidth=4 | setlocal tabstop=4

autocmd VimEnter,BufRead,BufNewFile *.cpp,*.hpp
    \ setlocal filetype=cpp | setlocal expandtab | setlocal shiftwidth=4 | setlocal tabstop=4
